      ...
      <Fade in={data ? true : false}>
        <div className='font-[Inter] text-white bg-black/75 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250px] py-5 px-5 rounded-lg border border-neutral-600 flex flex-col items-center justify-center gap-3'>
          ...
          <div className='w-full flex items-center gap-2'>
            <button className='bg-black/65 w-full py-1.5 border border-neutral-600 rounded
            hover:bg-lime-500/20 hover:border-lime-500 duration-200'
            onClick={() => quickSet(2)}>1/2</button>
            <button className='bg-black/65 w-full py-1.5 border border-neutral-600 rounded
            hover:bg-lime-500/20 hover:border-lime-500 duration-200'
            onClick={() => quickSet(3)}>1/3</button>
            <button className='bg-black/65 w-full py-1.5 border border-neutral-600 rounded
            hover:bg-lime-500/20 hover:border-lime-500 duration-200'
            onClick={() => quickSet(4)}>1/4</button>
          </div>
          <div className='w-full flex items-center gap-2'>
            <button className='bg-black/65 w-full py-1.5 border border-neutral-600 rounded text-sm
            hover:bg-lime-500/20 hover:border-lime-500 duration-200'
            onClick={close}>{Locale.ui_cancel || 'Cancel'}</button>
            <button className='bg-black/65 w-full py-1.5 border border-neutral-600 rounded text-sm
            hover:bg-lime-500/20 hover:border-lime-500 duration-200'
            onClick={split}>{Locale.ui_split || 'Split'}</button>
          </div>
        </div>
      </Fade>
    </>
